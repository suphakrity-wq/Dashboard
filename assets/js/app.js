...
import { $ } from './ui/dom.js?v=31';
import { store, refresh, visibleRows, subscribe } from './core/store.js?v=31';
import { BLOCKS, onRerender } from './ui/blocks.js?v=31';
import { renderNav, renderTabs, renderFilters, renderSummary, renderStatus, markDemo, setupNav } from './ui/shell.js?v=31';
import { PAGES, COMPUTED, TABS, FILTERS, ANALYSIS } from './pages/index.js?v=31';
import { FIXTURES, findFixture } from '../../test-data/fixtures.js?v=31';
...
if (DEMO) markDemo(fixture, FIXTURES);
onRerender(render);
subscribe(() => {
