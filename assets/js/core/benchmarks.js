...
export const BENCHMARKS = [
  ...
  },
  {
    ...
    source: 'reuters',
    read: (v, ext) => v >= ext ? 'สูงกว่าภาพรวมของประเทศ แสดงว่าฟีดวิดีโอเป็นช่องทางหลักของกลุ่มนี้'
...
export const CONTEXT_FACTS = [
  ...
  { text: 'รายงานระบุว่าเนื้อหาบันเทิงมักกลบข่าวเพื่อประโยชน์สาธารณะในตลาดสื่อไทย',
    source: 'reuters' },
  { text: 'คนไทยใช้อินเทอร์เน็ตเฉลี่ย 8 ชั่วโมง 57 นาทีต่อวัน ข้อจำกัดจึงไม่ใช่เวลาบนหน้าจอ แต่เป็นความสนใจที่จำกัด',
    source: 'etda' },
