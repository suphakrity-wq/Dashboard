...
import { avgOf, groupBy, num } from './compute.js?v=59';
import { pct } from './format.js?v=59';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=59';
