...
import { avgOf, groupBy, num } from './compute.js?v=15';
import { pct } from './format.js?v=15';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=15';
