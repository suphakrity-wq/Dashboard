...
import { avgOf, groupBy, num } from './compute.js?v=10';
import { pct } from './format.js?v=10';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=10';
