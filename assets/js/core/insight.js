...
import { avgOf, groupBy, num } from './compute.js?v=4';
import { pct } from './format.js?v=4';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=4';
