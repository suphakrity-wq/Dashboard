...
import { avgOf, groupBy, num } from './compute.js?v=6';
import { pct } from './format.js?v=6';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=6';
