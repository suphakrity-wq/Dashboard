...
import { avgOf, groupBy, num } from './compute.js?v=26';
import { pct } from './format.js?v=26';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=26';
