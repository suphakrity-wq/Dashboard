...
import { avgOf, groupBy, num } from './compute.js?v=45';
import { pct } from './format.js?v=45';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=45';
