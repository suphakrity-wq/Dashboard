...
import { avgOf, groupBy, num } from './compute.js?v=24';
import { pct } from './format.js?v=24';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=24';
