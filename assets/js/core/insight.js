...
import { avgOf, groupBy, num } from './compute.js?v=33';
import { pct } from './format.js?v=33';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=33';
