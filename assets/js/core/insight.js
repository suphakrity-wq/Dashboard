...
import { avgOf, groupBy, num } from './compute.js?v=52';
import { pct } from './format.js?v=52';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=52';
