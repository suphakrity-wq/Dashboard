...
import { avgOf, groupBy, num } from './compute.js?v=29';
import { pct } from './format.js?v=29';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=29';
