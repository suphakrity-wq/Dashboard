...
import { avgOf, groupBy, num } from './compute.js?v=32';
import { pct } from './format.js?v=32';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=32';
