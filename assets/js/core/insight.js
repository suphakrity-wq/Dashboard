...
import { avgOf, groupBy, num } from './compute.js?v=40';
import { pct } from './format.js?v=40';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=40';
