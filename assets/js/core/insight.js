...
import { avgOf, groupBy, num } from './compute.js?v=8';
import { pct } from './format.js?v=8';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=8';
