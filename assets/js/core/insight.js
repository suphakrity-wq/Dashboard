...
import { avgOf, groupBy, num } from './compute.js?v=53';
import { pct } from './format.js?v=53';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=53';
