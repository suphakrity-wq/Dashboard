...
import { avgOf, groupBy, num } from './compute.js?v=25';
import { pct } from './format.js?v=25';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=25';
