...
import { avgOf, groupBy, num } from './compute.js?v=3';
import { pct } from './format.js?v=3';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=3';
