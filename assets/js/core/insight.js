...
import { avgOf, groupBy, num } from './compute.js?v=60';
import { pct } from './format.js?v=60';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=60';
