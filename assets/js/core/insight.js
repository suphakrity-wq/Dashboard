...
import { avgOf, groupBy, num } from './compute.js?v=35';
import { pct } from './format.js?v=35';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=35';
