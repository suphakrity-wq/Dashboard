...
import { avgOf, groupBy, num } from './compute.js?v=12';
import { pct } from './format.js?v=12';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=12';
