...
import { avgOf, groupBy, num } from './compute.js?v=56';
import { pct } from './format.js?v=56';
import { pairedTTest, wilcoxonSignedRank, effectSizeLabel, requiredN } from './stats.js?v=56';
