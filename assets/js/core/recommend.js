...
import { pct } from './format.js?v=74';
import { groupBy } from './compute.js?v=74';
import { SOURCES } from './benchmarks.js?v=74';
import { analyzeText } from './textAnalysis.js?v=74';
import { causes as calcCauses } from './insight.js?v=74';
