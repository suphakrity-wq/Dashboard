...
import { groupBy } from './compute.js?v=150';
import { SOURCES } from './benchmarks.js?v=150';
import { analyzeText } from './textAnalysis.js?v=150';
import { causes as calcCauses } from './insight.js?v=150';
