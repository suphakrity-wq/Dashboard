...
import { pct } from './format.js?v=92';
import { groupBy } from './compute.js?v=92';
import { SOURCES } from './benchmarks.js?v=92';
import { analyzeText } from './textAnalysis.js?v=92';
import { causes as calcCauses } from './insight.js?v=92';
