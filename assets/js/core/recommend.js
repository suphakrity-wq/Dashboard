...
import { pct } from './format.js?v=117';
import { groupBy } from './compute.js?v=117';
import { SOURCES } from './benchmarks.js?v=117';
import { analyzeText } from './textAnalysis.js?v=117';
import { causes as calcCauses } from './insight.js?v=117';
