...
import { pct } from './format.js?v=82';
import { groupBy } from './compute.js?v=82';
import { SOURCES } from './benchmarks.js?v=82';
import { analyzeText } from './textAnalysis.js?v=82';
import { causes as calcCauses } from './insight.js?v=82';
