...
import { pct } from './format.js?v=81';
import { groupBy } from './compute.js?v=81';
import { SOURCES } from './benchmarks.js?v=81';
import { analyzeText } from './textAnalysis.js?v=81';
import { causes as calcCauses } from './insight.js?v=81';
