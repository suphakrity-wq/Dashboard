...
import { pct } from './format.js?v=72';
import { groupBy } from './compute.js?v=72';
import { SOURCES } from './benchmarks.js?v=72';
import { analyzeText } from './textAnalysis.js?v=72';
import { causes as calcCauses } from './insight.js?v=72';
