...
import { pct } from './format.js?v=85';
import { groupBy } from './compute.js?v=85';
import { SOURCES } from './benchmarks.js?v=85';
import { analyzeText } from './textAnalysis.js?v=85';
import { causes as calcCauses } from './insight.js?v=85';
