...
import { pct } from './format.js?v=77';
import { groupBy } from './compute.js?v=77';
import { SOURCES } from './benchmarks.js?v=77';
import { analyzeText } from './textAnalysis.js?v=77';
import { causes as calcCauses } from './insight.js?v=77';
