...
import { pct } from './format.js?v=80';
import { groupBy } from './compute.js?v=80';
import { SOURCES } from './benchmarks.js?v=80';
import { analyzeText } from './textAnalysis.js?v=80';
import { causes as calcCauses } from './insight.js?v=80';
