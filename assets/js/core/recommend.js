...
import { pct } from './format.js?v=79';
import { groupBy } from './compute.js?v=79';
import { SOURCES } from './benchmarks.js?v=79';
import { analyzeText } from './textAnalysis.js?v=79';
import { causes as calcCauses } from './insight.js?v=79';
