...
import { pct } from './format.js?v=83';
import { groupBy } from './compute.js?v=83';
import { SOURCES } from './benchmarks.js?v=83';
import { analyzeText } from './textAnalysis.js?v=83';
import { causes as calcCauses } from './insight.js?v=83';
