...
import { groupBy } from './compute.js?v=147';
import { SOURCES } from './benchmarks.js?v=147';
import { analyzeText } from './textAnalysis.js?v=147';
import { causes as calcCauses } from './insight.js?v=147';
