...
import { pct } from './format.js?v=115';
import { groupBy } from './compute.js?v=115';
import { SOURCES } from './benchmarks.js?v=115';
import { analyzeText } from './textAnalysis.js?v=115';
import { causes as calcCauses } from './insight.js?v=115';
