...
import { groupBy } from './compute.js?v=124';
import { SOURCES } from './benchmarks.js?v=124';
import { analyzeText } from './textAnalysis.js?v=124';
import { causes as calcCauses } from './insight.js?v=124';
