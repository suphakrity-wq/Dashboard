...
export const THEMES = [
  ...
  { id: 'trend', kind: 'pull', label: 'กระแส / คนรอบตัวพูดถึง',
    keywords: ['กระแส', 'ไวรัล', 'เพื่อนแชร์', 'คนพูดถึง', 'กำลังดัง', 'ทุกคนพูด', 'ตามกระแส',
               ...
               'บุคคลที่รู้จัก', 'คนที่รู้จัก', 'คนดัง', 'ดารา', 'นักแสดง', 'ศิลปิน'],
  ...
  { id: 'headline', kind: 'pull', label: 'พาดหัว / ภาพปก / คลิป',
    ...
    method: 'ระบุผลกระทบไว้ในพาดหัวบรรทัดเดียว และมีคลิปแนวตั้งประกอบ',
    source: 'yaros',
    effect: 'พาดหัวที่ให้ความหมายมากโดยใช้แรงคิดน้อย ถูกเลือกอ่านมากกว่า' },
  ...
  { id: 'clear', kind: 'pull', label: 'เข้าใจง่าย / ข้อมูลชัดเจน',
    ...
    method: 'สรุปใจความสำคัญไว้ในสองบรรทัดแรก แล้วจึงขยายรายละเอียด',
    source: 'yaros',
    effect: 'พาดหัวที่ให้ความหมายมากโดยใช้แรงคิดน้อย ถูกเลือกอ่านมากกว่า' },

  { id: 'useful', kind: 'pull', label: 'มีประโยชน์ / ได้ความรู้',
    keywords: ['มีประโยชน์', 'ได้ความรู้', 'ได้ข้อมูล', 'เอาไปใช้', 'ความรู้', 'สาระ'],
    method: 'ระบุให้ชัดว่าผู้อ่านจะได้อะไร เช่น ต้องเตรียมตัวอย่างไร และกระทบค่าใช้จ่ายเท่าใด',
    source: 'clt',
  ...
  { id: 'heavy', kind: 'barrier', label: 'ความอึดอัดจากปริมาณข่าวเชิงลบ',
