...
export default {
  ...
  blocks: [
    ...
    { type: "charts",
      ...
      charts: [
        { type: "buckets", wide: true,
          title: "คนส่วนใหญ่รู้จักกี่ข่าว",
          note: "แบ่งเป็น 3 ช่วงง่าย ๆ · ตัวเลขในแถบคือจำนวนคน",
          unit: "ข่าว",
          series: [
            { column: COL.countA, label: "ข่าวโลก" },
            { column: COL.countB, label: "ข่าวดราม่า" }
          ],
          hint: "ข่าวโลกมีคนอยู่ช่วง “รู้จักน้อย” เยอะกว่า ส่วนข่าวดราม่าอยู่ช่วง “รู้จักมาก” เยอะกว่า" },

        { type: "people", wide: true,
          title: "ผู้ตอบแต่ละคน รู้จักฝั่งไหนมากกว่า",
          note: "หนึ่งคนหนึ่งไอคอน นับหัวได้เลย",
          ...
          hint: "ถ้าคนเกือบทั้งหมดเป็นสีเดียวกัน แปลว่าเป็นกันเกือบทุกคน ไม่ใช่แค่บางคนที่ดึงค่าเฉลี่ย" }
      ] },
