...
import { splitValues, isNumericColumn } from '../core/compute.js?v=4';
import { store } from '../core/store.js?v=4';
import { verdict as calcVerdict, causes as calcCauses, pulls as calcPulls } from '../core/insight.js?v=4';
import { analyzeText } from '../core/textAnalysis.js?v=4';
import { wilsonInterval } from '../core/stats.js?v=4';
import { SOURCES, CONTEXT_FACTS, compareBenchmarks } from '../core/benchmarks.js?v=4';
import { aggregate, groupBy as groupRows } from '../core/compute.js?v=4';
